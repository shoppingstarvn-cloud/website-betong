...
export default function MUEmailBOCONhKCCNhBOLIConcretepro9() {
  return (
    <div>
...
<div className="mt-4 md:mt-0"><a className="font-['Inter'] text-xs font-normal tracking-wide text-slate-500 hover:text-[#FF6B00] transition-colors underline" href="#">Hủy đăng ký nhận báo cáo</a></div>
</footer>
</main>
