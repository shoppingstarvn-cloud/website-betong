...
export default function NhTKHThNgCCUHNhTNgAdminCms11() {
  return (
    <div>
      {/* SideNavBar */}
...
<button className="h-10 mt-5 bg-primary-container text-white hover:bg-primary-container/90 font-label-bold text-label-bold py-1.5 px-4 rounded transition-colors flex items-center gap-1.5">
