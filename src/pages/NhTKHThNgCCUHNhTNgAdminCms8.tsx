...
export default function NhTKHThNgCCUHNhTNgAdminCms8() {
  return (
    <div>
      {/* SideNavBar */}
...
{/* Table Controls */}
<div className="bg-[#F5F7F9] px-6 py-4 flex justify-between items-center border-b border-outline-variant/30"><div className="relative flex-1 max-w-md mr-4">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[20px]">search</span>
<input className="w-full pl-10 pr-4 py-2 bg-surface-container-lowest border border-outline-variant/50 rounded text-sm text-on-surface focus:ring-1 focus:ring-primary-container focus:border-primary-container transition-all outline-none" placeholder="Search in logs..." type="text"/>
</div><div className="flex items-center gap-2 ml-2">
<label className="text-xs font-medium text-slate-500 whitespace-nowrap uppercase tracking-wider">Rows:</label>
<select className="h-10 px-3 py-2 bg-surface-container-lowest border border-outline-variant/50 text-on-surface text-sm rounded focus:ring-1 focus:ring-primary-container focus:border-primary-container block w-20 outline-none transition-all cursor-pointer">
<option selected="">10</option>
<option>25</option>
<option>50</option>
<option>100</option>
</select>
</div><div className="flex items-center gap-4 ml-4 pl-4 border-l border-outline-variant/30">
<div className="flex flex-col gap-1">
<label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Từ ngày</label>
<input className="h-10 px-3 py-1.5 bg-surface-container-lowest border border-outline-variant/50 text-on-surface text-sm rounded focus:ring-1 focus:ring-primary-container focus:border-primary-container block outline-none transition-all cursor-pointer font-['Inter']" type="date"/>
</div>
<div className="flex flex-col gap-1">
...
<div className="flex flex-col gap-1">
<label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Người dùng</label>
<select className="h-10 px-3 py-1.5 bg-surface-container-lowest border border-outline-variant/50 text-on-surface text-sm rounded focus:ring-1 focus:ring-primary-container focus:border-primary-container block outline-none transition-all cursor-pointer font-['Inter']">
<option selected="">Tất cả người dùng</option>
<option>admin@system.local</option>
<option>system_service</option>
<option>db_admin</option>
<option>unknown</option>
</select>
</div><button className="h-10 mt-5 bg-primary-container text-white hover:bg-primary-container/90 font-label-bold text-label-bold py-1.5 px-4 rounded transition-colors flex items-center gap-1.5">
...
<span className="material-symbols-outlined text-[16px]">picture_as_pdf</span>
                                Xuất PDF
                            </button><button className="bg-white border border-outline-variant/50 text-primary-container hover:bg-slate-50 font-label-bold text-label-bold py-1.5 px-4 rounded transition-colors flex items-center gap-1.5"><span className="material-symbols-outlined text-[16px]">download_for_offline</span>Tải xuống tất cả</button><button className="bg-white border border-outline-variant/50 text-primary-container hover:bg-slate-50 font-label-bold text-label-bold py-1.5 px-4 rounded transition-colors flex items-center gap-1.5 ml-2" onclick="window.print()">
...
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider"><div className="flex items-center gap-1 cursor-pointer hover:text-orange-200 transition-colors"><span>Timestamp</span><span className="material-symbols-outlined text-[16px] opacity-70">unfold_more</span></div></th>
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider"><div className="flex items-center gap-1 cursor-pointer hover:text-orange-200 transition-colors"><span>User</span><span className="material-symbols-outlined text-[16px] opacity-70">unfold_more</span></div></th>
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider"><div className="flex items-center gap-1 cursor-pointer hover:text-orange-200 transition-colors"><span>Action</span><span className="material-symbols-outlined text-[16px] opacity-70">unfold_more</span></div></th>
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider"><div className="flex items-center gap-1 cursor-pointer hover:text-orange-200 transition-colors"><span>Module</span><span className="material-symbols-outlined text-[16px] opacity-70">unfold_more</span></div></th>
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider">IP</th>
<th className="py-3 px-6 font-label-bold text-label-bold uppercase tracking-wider"><div className="flex items-center gap-1 cursor-pointer hover:text-orange-200 transition-colors"><span>Status</span><span className="material-symbols-outlined text-[16px] opacity-70">unfold_more</span></div></th>
</tr>
</thead>
...
<span className="text-sm text-on-surface-variant font-body-sm">Showing 1 to 10 of 2,451 entries</span>
<div className="flex items-center gap-1">
<button className="flex items-center gap-1 px-3 py-1.5 border border-outline-variant/50 rounded bg-white text-on-surface-variant hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled="">
<span className="material-symbols-outlined text-[18px]">chevron_left</span>
<span className="text-sm font-medium">Previous</span>
</button>
<button className="w-9 h-9 flex items-center justify-center rounded bg-primary-container text-white font-medium text-sm">1</button>
<button className="w-9 h-9 flex items-center justify-center rounded bg-white border border-outline-variant/50 text-on-surface-variant hover:bg-slate-50 font-medium text-sm transition-colors">2</button>
<button className="w-9 h-9 flex items-center justify-center rounded bg-white border border-outline-variant/50 text-on-surface-variant hover:bg-slate-50 font-medium text-sm transition-colors">3</button>
<span className="px-2 text-on-surface-variant">...</span>
<button className="w-9 h-9 flex items-center justify-center rounded bg-white border border-outline-variant/50 text-on-surface-variant hover:bg-slate-50 font-medium text-sm transition-colors">246</button>
<button className="flex items-center gap-1 px-3 py-1.5 border border-outline-variant/50 rounded bg-white text-on-surface-variant hover:bg-slate-50 transition-colors">
