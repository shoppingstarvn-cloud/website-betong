...
export default function TOLChMIAdminCms1() {
  return (
    <div>
      {/* TopNavBar */}
...
{/* Modal Dialog */}
<div className="bg-white w-full max-w-2xl rounded shadow-2xl overflow-hidden flex flex-col"><div className="bg-emerald-50 border-b border-emerald-100 px-8 py-3 flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
<div className="flex-shrink-0 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center">
<span className="material-symbols-outlined text-white text-[16px] font-bold">check</span>
</div>
<p className="font-body-sm text-emerald-800 font-medium">Lịch báo cáo đã được tạo thành công!</p>
</div>
{/* Header */}
