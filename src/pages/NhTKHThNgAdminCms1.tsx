...
export default function NhTKHThNgAdminCms1() {
  return (
    <div>
      {/* SideNavBar */}
...
<button className="w-full md:w-auto px-4 py-2 border border-outline-variant text-on-surface-variant font-table-data text-table-data rounded hover:bg-surface-container-high transition-colors flex items-center justify-center gap-2 h-[42px]">
